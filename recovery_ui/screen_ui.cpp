...
//Fix by yanghuakun for Disable animation display 2024-10-18 BEGIN
bool show_animation_ = true;  // Controls whether animations are displayed
//Fix by yanghuakun for Disable animation display 2024-10-18 END
...
void ScreenRecoveryUI::draw_foreground_locked() {
  //Fix by yanghuakun for Disable animation display 2024-10-18 BEGIN
  if (show_animation_ && current_icon_ != NONE) {
  //Fix by yanghuakun for Disable animation display 2024-10-18 END
...
void ScreenRecoveryUI::ProgressThreadLoop() {
  ...
  while (!progress_thread_stopped_) {
    ...
    bool redraw = false;
    {
      ...
      //Fix by yanghuakun for Disable animation display 2024-10-18 BEGIN
      if (show_animation_ && (current_icon_ == INSTALLING_UPDATE || current_icon_ == ERASING) && !show_text) {
      //Fix by yanghuakun for Disable animation display 2024-10-18 END
        if (!intro_done_) {
...
bool ScreenRecoveryUI::Init(const std::string& locale) {
  ...
  //Fix by yanghuakun for Disable animation display 2024-10-18 BEGIN
  // Disable animation display
  show_animation_ = false;
  //Fix by yanghuakun for Disable animation display 2024-10-18 END
...
void ScreenRecoveryUI::LoadAnimation() {
  ...
  // Free animation-related resources
  intro_frames_.shrink_to_fit();
  loop_frames_.shrink_to_fit();
